...
class EnumProperty<T>(id: Id, val serializer: Serializer<T>, defaultValue: T? = null, currentValue: T? = defaultValue) : AbstractProperty<T>(id, defaultValue, currentValue) where T : Enum<T>, T : GdEnum {
